...
from fastvideo.models.videoalign.utils import (
    ModelConfig,
    PEFTLoraConfig,
    TrainingConfig,
...
class VideoVLMRewardInference:
    def __init__(
        ...
        data_config, _, model_config, peft_lora_config, inference_config = (
...
if __name__ == "__main__":
    ...
    video_paths = [
        "/capstor/scratch/cscs/mhasan/DanceGRPO/videos/skyreels_0_0.mp4",
        "/capstor/scratch/cscs/mhasan/DanceGRPO/videos/skyreels_0_1.mp4",
        "/capstor/scratch/cscs/mhasan/DanceGRPO/videos/skyreels_0_2.mp4",
    ]
